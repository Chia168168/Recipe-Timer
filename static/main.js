...
// --- Helper Functions ---
function urlBase64ToUint8Array(base64String) { /* ... 內容不變 ... */ }
function showNotification(message, type = 'info') { /* ... 內容不變 ... */ }
...
async function subscribeUser() { /* ... 內容不變 ... */ }
async function registerServiceWorker() { /* ... 內容不變 ... */ }
...
async function handleTimerClick(minutes, recipeName) {
    // ... (原本的 handleTimerClick 邏輯不變) ...
    // 在 fetch 請求成功後，立即刷新一次列表
    try {
        // ... (原本的 fetch('/start_timer', ...) 程式碼)
